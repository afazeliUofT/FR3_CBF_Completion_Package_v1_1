...
def main() -> int:
    ...
    # Preserve identifier strings exactly.  The TAFL frequency-record and
    # authorization identifiers can contain leading zeroes; allowing pandas to
    # infer numeric dtypes would silently remove those zeroes and break later
    # joins to the canonical TAFL source.
    df = pd.read_csv(
        eligible_path,
        dtype={
            "pair_id_candidate": str,
            "auth_number": str,
            "tx_freq_rec_id": str,
            "rx_freq_rec_id": str,
            "tx_ref_id": str,
