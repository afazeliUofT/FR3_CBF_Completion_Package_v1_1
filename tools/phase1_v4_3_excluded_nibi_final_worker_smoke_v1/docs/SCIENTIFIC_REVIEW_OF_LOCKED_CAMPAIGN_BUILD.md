...
the final campaign worker and fresh Nibi channel-generation path have not yet
been exercised together. A one-seed Nibi run is therefore the minimum
non-confirmatory integration test before any full-campaign authorization
review.

## Assumptions requiring validation

The smoke must validate exact Nibi regeneration of the seed-43999 channel,
