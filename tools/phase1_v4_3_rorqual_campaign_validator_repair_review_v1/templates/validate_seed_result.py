#!/usr/bin/env python3
"""Strict structural and scientific-gate validation of one v4.3 seed result."""
...
PASS_STATUS = "PASS_PHASE1_V4_3_SEED_RESULT_REVIEW_REQUIRED"
FAIL_STATUS = "FAIL_PHASE1_V4_3_CANDIDATE_HARD_GATE_RESULT_REVIEW_REQUIRED"
...
def main() -> int:
    ...
    if audit["candidate_source_manifest_sha256"] != contract["candidate_v4_3"][
    ...
    for slot in range(5):
        ...
        if not np.array_equal(payload_bytes, 4 * coefficient_counts):
            raise ValueError(f"pass {slot}: payload lower-bound trace mismatch")
    ...
    print("PHASE1_V4_3_SEED_RESULT_STRUCTURAL_VALIDATION=PASS")
