...
def main() -> int:
    ...
    name = f"FR3_RORQUAL_V4_4_SCHEDULING_INFRA_REPAIR_R1_{a.array_job_id}"
    ...
    for source, relative in [
        ...
        (package_root / "config/V44_INFRASTRUCTURE_REPAIR_CONTRACT.json", "bindings/V44_INFRASTRUCTURE_REPAIR_CONTRACT.json"),
        (run_root / "local_audit/PRIOR_V44_INFRASTRUCTURE_FAILURE_AUDIT.json", "audits/PRIOR_V44_INFRASTRUCTURE_FAILURE_AUDIT.json"),
