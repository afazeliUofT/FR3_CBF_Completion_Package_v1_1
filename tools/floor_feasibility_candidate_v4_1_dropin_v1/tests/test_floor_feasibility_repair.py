...
def test_stream_redistribution_repairs_when_any_sector_scalar_is_infeasible() -> None:
    ...
    # enough, but power-preserving stream redistribution can.
...
def test_repair_interval_uses_power_preserving_local_stream_redistribution() -> None:
    state = State(
