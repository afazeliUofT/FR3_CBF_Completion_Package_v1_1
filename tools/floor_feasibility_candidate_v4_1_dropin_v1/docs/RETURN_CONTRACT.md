...
1. `FR3_RORQUAL_FLOOR_FEASIBILITY_CANDIDATE_V4_1_<job-id>.zip` or
   `FR3_RORQUAL_FLOOR_FEASIBILITY_CANDIDATE_V4_1_PREJOB_FAILURE.zip`;
...
`evidence/phase1_floor_feasibility_candidate_v4_1_dropin_v1` on branch
`e3-first-sector-p452`. NPZ traces remain in the returned ZIP and are not pushed
to GitHub.
