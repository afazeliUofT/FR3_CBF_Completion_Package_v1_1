\begin{table}[t]
\caption{Fresh 30-seed holdout: candidate-v4.5 headline results.}
\label{tab:holdout-key}
\centering
\footnotesize
...
Floor-violation user-seconds & $16{,}646$\\
Floor reduction vs. predictive & $81.47\%$\\
Floor reduction vs. safe static & $84.76\%$\\
Residual scheduling intervals & $1{,}328$\\
Maximum normalized floor shortfall & $57.26\%$\\
\bottomrule
\end{tabular}
\end{table}
